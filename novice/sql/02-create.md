...
<table>
	...
	<td valign="top">
	<table>
	<tr><th colspan=3><strong>Person</strong>: people who took readings.</th></tr>
		<tr> <th>
		ident
		</th> <th>
		personal
	...
	<table>
	<tr><th colspan=2><strong>Site</strong>: locations where readings were taken.</th></tr>
	  <tr> <th>
	name
	</th> <th>
	lat
...
<p>Currently the data is stored in 4 text files
<div class="in">
<pre>$ls data/</pre>
</div>
<div class="out">
...
<p>The <b>sqlite3</b> command takes 1 optional parameter, the file to use for the database.</p>

<div class="in">
<pre>$sqlite3 data/Survey.db</pre>
<pre>sqlite>.tables --Note this command returns nothing as we have not created any tables yet
<pre>sqlite>.exit</pre>
</div>
<div class="in">
<pre>$ls data/</pre>
...
<p>SQL commands can span many lines, the semi-colon <code>;</code> tells the database manager we have finished our statement.
#### Datatypes in sqlite
...
<div class="in">
<pre>sqlite>.seperator ","</pre>
<pre>sqlite>.import data/Person.csv Person</pre>
<pre>sqlite>SELECT * FROM Person;</p>
</div>
<div class="out">
<pre><table>
...
<p>The file <code>create_example_db.sql</code> contains the SQL commands to create the examples and populate them from the .csv files.
<div class="in">
